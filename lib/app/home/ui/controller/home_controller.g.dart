...
mixin _$HomeController on _HomeController, Store {
  ...
  @override
  Future<void> saveUserInfoInDb(LatLng position) {
    return _$saveUserInfoInDbAsyncAction
        .run(() => super.saveUserInfoInDb(position));
  }

  final _$getCurrentLocationAsyncAction =
      AsyncAction('_HomeController.getCurrentLocation');
